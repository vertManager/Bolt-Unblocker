(()=>{var e={8810:function(e,t,n){n.d(t,{Sp:()=>s,h3:()=>r,t8:()=>i}),"$scramjet"in self||(self.$scramjet={version:{build:"9184008",version:"1.0.2-dev"},codec:{},flagEnabled:s});let r=self.$scramjet,o=Function;function i(){r.codec.encode=o(`return ${r.config.codec.encode}`)(),r.codec.decode=o(`return ${r.config.codec.decode}`)()}function s(e,t){let n=r.config.flags[e];for(let n in r.config.siteFlags){let o=r.config.siteFlags[n];if(new RegExp(n).test(t.href)&&e in o)return o[e]}return n}},4471:function(e,t,n){n.d(t,{$O:()=>p,Ag:()=>d,KF:()=>i,Sd:()=>c,U5:()=>u,V6:()=>m,r4:()=>g});var r=n(8810);let{util:{BareClient:o,ScramjetHeaders:i,BareMuxConnection:s},url:{rewriteUrl:a,unrewriteUrl:c,rewriteBlob:l,unrewriteBlob:d},rewrite:{rewriteCss:u,unrewriteCss:f,rewriteHtml:g,unrewriteHtml:h,rewriteSrcset:b,rewriteJs:w,rewriteHeaders:m,rewriteWorkers:p,htmlRules:_},CookieStore:y}=r.h3.shared;r.h3.config},4079:function(e,t,n){n.d(t,{LC:()=>c,o:()=>i});var r=n(7418),o=n(8810);async function i(){let e=await fetch(o.h3.config.files.wasm).then(e=>e.arrayBuffer());self.REAL_WASM=new Uint8Array(e)}self.WASM&&(self.REAL_WASM=Uint8Array.from(atob(self.WASM),e=>e.charCodeAt(0))),Error.stackTraceLimit=50;let s=new TextDecoder,a="\0asm".split("").map(e=>e.charCodeAt(0));function c(e,t,n,i=!1){return function(e,t,n,i=!1){if((0,o.Sp)("naiiveRewriter",n.origin)){var c;return{js:("string"!=typeof(c="string"==typeof e?e:new TextDecoder().decode(e))&&(c=new TextDecoder().decode(c)),`
		with (${o.h3.config.globals.wrapfn}(globalThis)) {

			${c}

		}
	`),tag:"",map:null}}return function(e,t,n,i){let c;if(!(self.REAL_WASM&&self.REAL_WASM instanceof Uint8Array))throw Error("rewriter wasm not found (was it fetched correctly?)");if(![...self.REAL_WASM.slice(0,4)].every((e,t)=>e===a[t]))throw Error("rewriter wasm does not have wasm magic (was it fetched correctly?)\nrewriter wasm contents: "+s.decode(self.REAL_WASM));(0,r.rb)({module:new WebAssembly.Module(self.REAL_WASM)});let l=performance.now();try{c="string"==typeof e?(0,r.DF)(e,n.base.href,t||"(unknown)",i,o.h3):(0,r.Fp)(e,n.base.href,t||"(unknown)",i,o.h3)}catch(n){return console.warn("failed rewriting js for",t,n.message,e),{js:e,tag:"",map:null}}let d=performance.now(),{js:u,map:f,scramtag:g,errors:h,duration:b}=c;if((0,o.Sp)("sourcemaps",n.base)&&!globalThis.clients&&(globalThis[globalThis.$scramjet.config.globals.pushsourcemapfn](Array.from(f),g),f=null),(0,o.Sp)("rewriterLogs",n.base))for(let e of h)console.error("oxc parse error",e);if((0,o.Sp)("rewriterLogs",n.base)){let e=(d-l-Number(b)).toFixed(2);console.log(`oxc rewrite for "${t||"(unknown)"}" was ${b<1n?"BLAZINGLY FAST":b<500n?"decent speed":"really slow"} (${b}ms; ${e}ms overhead)`)}return{js:"string"==typeof e?s.decode(u):u,tag:g,map:f}}(e,t,n,i)}(e,t,n,i)}},4155:function(e,t,n){n.d(t,{O:()=>o});var r=n(8810);function o(e,t){let n={"content-type":"text/html"};return crossOriginIsolated&&(n["Cross-Origin-Embedder-Policy"]="require-corp"),new Response(function(e,t){let n=`
